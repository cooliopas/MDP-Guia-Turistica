//
//  RecreacionCellFiltroTableViewCell.swift
//  GT1
//
...
class RecreacionCellFiltroTableViewCell: UITableViewCell {
	...
	@IBAction func filtroNombreTextFieldAction(sender: UITextField) {
		...
		let recreacionVC = appDelegate.traeVC("recreacion") as! RecreacionViewController
